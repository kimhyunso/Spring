...
public class QParent extends EntityPathBase<Parent> {
    ...
    private static final long serialVersionUID = -139938109L;

    public static final QParent parent = new QParent("parent");

    public final ListPath<Child, QChild> childes = this.<Child, QChild>createList("childes", Child.class, QChild.class, PathInits.DIRECT2);
