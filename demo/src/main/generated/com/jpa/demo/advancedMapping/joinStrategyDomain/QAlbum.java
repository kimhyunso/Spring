...
public class QAlbum extends EntityPathBase<Album> {
    ...
    private static final long serialVersionUID = 873334031L;

    public static final QAlbum album = new QAlbum("album");

    public final com.jpa.demo.advancedMapping.singleStrategyDomain.QItem _super = new com.jpa.demo.advancedMapping.singleStrategyDomain.QItem(this);
